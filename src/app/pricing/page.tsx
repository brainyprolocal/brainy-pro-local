...
export const metadata: Metadata = {
  title: 'Pricing & Plans',
  description: 'Simple, transparent pricing for Maryland home service professionals. Choose the tier that fits your business — from our free Network membership to the Ultimate custom plan.',
};
